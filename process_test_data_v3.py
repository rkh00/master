...
coordinate_systems = {"utm32": [25832], "utm33": [25833], "utm35": [25835]}
...
df_testdata = pd.read_csv("all_test_data_v7.csv")
...
columns = ["centroid","water","coordsys","small_munic_min","small_munic_max","small_munic_avg_diff","small_munic_median_diff","small_munic_std_diff","small_munic_rmse","large_munic_min","large_munic_max","large_munic_avg_diff","large_munic_median_diff","large_munic_std_diff","large_munic_rmse","coastal_munic_min","coastal_munic_max","coastal_munic_avg_diff","coastal_munic_median_diff","coastal_munic_std_diff","coastal_munic_rmse","inland_munic_min","inland_munic_max","inland_munic_avg_diff","inland_munic_median_diff","inland_munic_std_diff","inland_munic_rmse","overall_munic_avg","overall_munic_rmse","small_county_diff","large_county_diff","coastal_county_diff","inland_county_diff","avg_count_diff"]
...
for water_key, water_value in water.items():
    for coordsys_key, coordsys_value in coordinate_systems.items():
        ...
        for centroid in centroids:
            ...
            small_munic_min = np.round(np.min(small_munic_diffs), 1)
            small_munic_max = np.round(np.max(small_munic_diffs), 1)
            small_munic_avg_diff = np.round(np.mean(small_munic_diffs), 1)
            small_munic_median_diff = np.round(np.median(small_munic_diffs), 1)
            small_munic_std_diff = np.round(np.std(small_munic_diffs), 1)
            small_munic_rmse = np.round(np.sqrt((small_munic_diffs**2).mean()), 1)
            large_munic_min = np.round(np.min(large_munic_diffs), 1)
            large_munic_max = np.round(np.max(large_munic_diffs), 1)
            large_munic_avg_diff = np.round(np.mean(large_munic_diffs), 1)
            large_munic_median_diff = np.round(np.median(large_munic_diffs), 1)
            large_munic_std_diff = np.round(np.std(large_munic_diffs), 1)
            large_munic_rmse = np.round(np.sqrt((large_munic_diffs**2).mean()), 1)
            coastal_munic_min = np.round(np.min(coastal_munic_diffs), 1)
            coastal_munic_max = np.round(np.max(coastal_munic_diffs), 1)
            coastal_munic_avg_diff = np.round(np.mean(coastal_munic_diffs), 1)
            coastal_munic_median_diff = np.round(np.median(coastal_munic_diffs), 1)
            coastal_munic_std_diff = np.round(np.std(coastal_munic_diffs), 1)
            coastal_munic_rmse = np.round(np.sqrt((coastal_munic_diffs**2).mean()), 1)
            inland_munic_min = np.round(np.min(inland_munic_diffs), 1)
            inland_munic_max = np.round(np.max(inland_munic_diffs), 1)
            inland_munic_avg_diff = np.round(np.mean(inland_munic_diffs), 1)
            inland_munic_median_diff = np.round(np.median(inland_munic_diffs), 1)
            inland_munic_std_diff = np.round(np.std(inland_munic_diffs), 1)
            inland_munic_rmse = np.round(np.sqrt((inland_munic_diffs**2).mean()), 1)
            overall_munic_avg = np.round(np.mean(combined_munic_diffs), 1)
            overall_munic_rmse = np.round(np.sqrt((combined_munic_diffs**2).mean()), 1)
            if(small_count_diffs.size > 0):
                small_count_diff = np.round(small_count_diffs[0], 1)
            if(large_count_diffs.size > 0):
                large_count_diff = np.round(large_count_diffs[0], 1)
            if(coastal_count_diffs.size > 0):
                coastal_count_diff = np.round(coastal_count_diffs[0], 1)
            if(inland_count_diffs.size > 0):
                inland_count_diff = np.round(inland_count_diffs[0], 1)
            avg_count_diff = np.round(np.mean(np.array([small_count_diff,large_count_diff,coastal_count_diff,inland_count_diff])), 1)
...
df_final.to_csv("test_data_processed_v7.csv")